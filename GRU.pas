...
begin
Image1.Picture.LoadFromFile('E:\GRU\11.bmp');
...
CBKatalog.Items.LoadFromFile('E:\Gru\ComboBoxi\ComboBoxKatalog');
CBIndex.Items.LoadFromFile('E:\Gru\ComboBoxi\ComboBoxIndex');
CBIndexAB.Items.LoadFromFile('E:\Gru\ComboBoxi\ComboBoxIndexAB');
...
begin
LoadingFileName:='E:\GRU\'+EdtLoad.Text+'.bmp' ;
...
begin
CBKatalog.Items.SaveToFile('E:\Gru\ComboBoxi\ComboBoxKatalog');
CBIndex.Items.SaveToFile('E:\Gru\ComboBoxi\ComboBoxIndex');
CBIndexAB.Items.SaveToFile('E:\Gru\ComboBoxi\ComboBoxIndexAB');
CBKatalog.SetFocus;
end;
